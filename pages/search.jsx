  ...
  return (
    <Container>
      <Wrapper>
        ...
        <InputContainer>
          <FromToIcons>
            <CircleImg src="/static/img/circle.png" alt="" />
            <LineImg src="/staticimg/line.png" alt="" />
            <SquareImg src="/staticimg/square.png" alt="" />
          </FromToIcons>
          <InputBoxes>
            <Input
          ...
          <PlusIcon src="/static/img/plus.png" alt="plus" />
        </InputContainer>
        <SavedPlaces>
          <StarIcon src="/static/img/star.png" alt="" />
          Saved Places
        </SavedPlaces>
        <Link
          href={{
